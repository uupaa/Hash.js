...
var Hash = {
        ...
        "Adler32":  null,   // Hash.Adler32(source:Uint8Array|String, hex:Boolean = false, seed:Integer = 1):UINT32|HexString
        "XXHash":   null,   // Hash.XXHash(source:Uint8Array|String, hex:Boolean = false, seed:Integer = 0):UINT32|HexString
        "Murmur":   null,   // Hash.Murmur(source:Uint8Array|String, hex:Boolean = false, seed:Integer = 0):UINT32|HexString
        "CRC32":    null,   // Hash.CRC32(source:Uint8Array|String, hex:Boolean = false, offset:UINT32 = 0, length:UINT32 = 0, crc:UINT32 = 0):UINT32|HexString
