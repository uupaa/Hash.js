...
//{@md5
Hash["MD5"]     = MD5;          // Hash.MD5(source:Uint8Array|String, hex:Boolean = false):Uint8Array|HexString
//}@md5
//{@sha1
Hash["SHA1"]    = SHA1;         // Hash.SHA1(source:Uint8Array|String, hex:Boolean = false):Uint8Array|HexString
//}@sha1
//{@hmac
Hash["HMAC"]    = HMAC;         // Hash.HMAC(method:String, key:Uint8Array|String, message:Uint8Array|String, hex:Boolean = false):Uint8Array|HexString
//}@hamc
//{@adler32
Hash["Adler32"] = Adler32;      // Hash.Adler32(source:Uint8Array|String, hex:Boolean = false, seed:Integer = 1):UINT32|HexString
//}@adler32
//{@xxhash
Hash["XXHash"]  = XXHash;       // Hash.XXHash(source:Uint8Array|String, hex:Boolean = false, seed:Integer = 0):UINT32|HexString
//}@xxhash
//{@murmur
Hash["Murmur"]  = Murmur;       // Hash.Murmur(source:Uint8Array|String, hex:Boolean = false, seed:Integer = 0):UINT32|HexString
//}@murmur
//{@crc32
Hash["CRC32"]   = CRC32;        // Hash.CRC32(source:Uint8Array|String, hex:Boolean = false, offset:UINT32 = 0, length:UINT32 = 0, crc:UINT32 = 0):UINT32|HexString
//}@crc32
...
//}@dev
    ...
    return hex ? _toHexString(result) : result;
}
...
//}@dev
    ...
    return hex ? _toHexString(u32) : u32;
}
...
// === CRC32 ===============================================
//{@crc32
function CRC32(source, // @arg Uint8Array|String
               hex,    // @arg Boolean = false
               offset, // @arg UINT32 = 0
    ...
    var i  = offset || 0;
    var l  = length || source_.length - i;
    var iz = i + l;

    c[0] ^= 0xffffffff;

    for (; i < iz; ++i) {
        c[0] = (c[0] >>> 8) ^ CRC32_TABLE[(c[0] ^ source_[i]) & 0xff];
    }
    var u32 = (c[0] ^ 0xffffffff) >>> 0;
...
function _toHexString(source) { // @arg Uint8Array|Uint16Array|Uint32Array|UINT32
